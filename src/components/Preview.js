  ...
  return (
    <div className="top-panel" ref={(el) => self = el}>
      ...
      <div className="top-panel__buttons">
        <a href="#" className="top-panel__btn d-none d-sm-inline-block btn btn-special mr-3 btn-with-icon">
        ...
        <a href="#" className="top-panel__btn d-none d-sm-inline-block btn btn-special btn-with-icon">
