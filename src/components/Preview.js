...
const TopPanel = ({ backLink }) => {
  ...
  return (
    <div className="top-panel" ref={(el) => self = el}>
      <a href={backLink} className="btn btn-link btn-special--link mr-3 btn-with-icon">
        <svg className="btn__icon" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24"><path d="M3 12l18-12v24z" /></svg>
        Go Back
      </a>
      <a href="#" className="btn ml-auto btn-special mr-3 btn-with-icon">
      ...
      <a href="#" className="btn btn-special btn-with-icon">
